...
Milano (with honors), defending the dissertation "Exploiting Environment Configurability in Reinforcement Learning" ([Slides](https://albertometelli.github.io/files/slides_phd_thesis.pdf)),
